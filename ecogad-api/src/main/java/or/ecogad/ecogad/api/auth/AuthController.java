package or.ecogad.ecogad.api.auth;

import io.swagger.v3.oas.annotations.Operation;
import io.swagger.v3.oas.annotations.tags.Tag;
import jakarta.validation.Valid;
import lombok.RequiredArgsConstructor;
import or.ecogad.ecogad.api.auth.request.AdminLoginRequest;
import or.ecogad.ecogad.api.auth.request.AdminSignupRequest;
import or.ecogad.ecogad.api.auth.response.AdminLoginResponse;
import or.ecogad.ecogad.api.auth.response.AdminProfileResponse;
import or.ecogad.ecogad.auth.principal.AdminPrincipal;
...
import or.ecogad.ecogad.domain.auth.application.service.AdminAuthService;
