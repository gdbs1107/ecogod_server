...
class AdminAuthServiceTest {
    ...
    void signup_success() {
        ...
        AdminUser saved = AdminUser.restore(1L, "admin", "encoded", "관리자", or.ecogad.ecogad.domain.auth.domain.model.AdminRole.ADMIN, null, null);
    ...
    void login_success() {
        ...
        AdminUser adminUser = AdminUser.restore(1L, "admin", "encoded", "관리자", or.ecogad.ecogad.domain.auth.domain.model.AdminRole.ADMIN, null, null);
